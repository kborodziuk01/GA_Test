globals [ max-sheep sum_sheep sum_wolf mean_wolves mean_sheep]  ; don't let the sheep population grow too large
...
to setup
  ...
  set sum_sheep count sheep
  set sum_wolf  count wolves
end
...
to mean-stuff
  ...
  set sum_sheep sum_sheep + count sheep
  set sum_wolf sum_wolf + count wolves
  set mean_sheep sum_sheep / ticks
  set mean_wolves sum_wolf / ticks
...
"" ""
PENS
"default" 1.0 0 -10899396 true "" "plot mean_sheep "
"pen-1" 1.0 0 -2674135 true "" "plot mean_wolves"
